                  ...
                  fluidPage(
                      ...
                      sidebarLayout(
                          sidebarPanel(
                              ...
                              textInput("FY 17-18 REPORTING MONTH_cs", "FY 17-18 REPORTING MONTH_cs", ""), 
                              textInput("CATEGORY_cs", "CATEGORY_cs", ""),
                              textInput("CS PROJECT Site Name &  FCSI #_cs", "CS PROJECT Site Name &  FCSI #_cs", ""),
                              selectInput("CS PROJECT TIME SHARING (YES/NO)_cs", "CS PROJECT TIME SHARING (YES/NO)_cs", c("Yes", "No"), selected = " "),
                              ...
                              textInput("COMMENTS (For Added Clarity)_cs", "COMMENTS (For Added Clarity)_cs", ""),
                  ...
                  fluidPage(
                      ...
                      sidebarLayout(
                          sidebarPanel(
                              ...
                              textInput("FY 17-18 REPORTING MONTH_ea", "FY 17-18 REPORTING MONTH_ea", ""), 
                              textInput("CATEGORY_ea", "CATEGORY_ea", ""),
                              textInput("EA PROJECT NAME_ea", "EA PROJECT NAME_ea", ""),
                              selectInput("EA PROJECT TIME SHARING (YES/NO)_ea", "EA PROJECT TIME SHARING (YES/NO)_ea", c("Yes", "No")),
                              ...
                              textInput("ABORIGINAL CONSULTATION (YES/NO)_ea", "ABORIGINAL CONSULTATION (YES/NO)_ea", ""),
